...
export const TimelinePanel = () => {
    ...
    return (
        <div className="flex flex-col gap-4 overflow-y-auto max-h-[300px] pr-2 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-black/10 dark:bg-white/10 [&::-webkit-scrollbar-track]:bg-transparent relative z-30 pointer-events-auto">
            {events.map((e, i) => (
                <div key={i} className="p-4 bg-white/80 dark:bg-black/60 backdrop-blur-3xl border border-black/10 dark:border-white/10 rounded-2xl group hover:border-accent/40 transition-all flex items-start gap-4">
                    <div className="mt-1">
                    ...
                    <div className="space-y-1 w-full">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`text-[7px] font-black uppercase tracking-tighter px-1.5 py-0.5 rounded ${
                                e.type === "discovery" ? 'bg-white dark:bg-[#0a0a0a]ccent/10 text-accent' : 
